 ...
 * @author MKA
 */
public class dlgGuncelle extends javax.swing.JDialog {

    frmTablo ft = new frmTablo();
     ...
     */
    public dlgGuncelle(java.awt.Frame parent, boolean modal, int selectedRow) {
        super(parent, modal);
        initComponents();
        actionOlustur();
        comboDoldur();
    ...
    private void cmbIlPropertyChange(java.beans.PropertyChangeEvent evt) {                                     
